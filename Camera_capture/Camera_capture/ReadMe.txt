========================================================================
    WIN32-ANWENDUNG: Camera_capture-Projektübersicht
========================================================================

Diese Camera_capture-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre Camera_capture-Anwendung besteht.


Camera_capture.vcxproj
...
Camera_capture.vcxproj.filters
...
Camera_capture.ico
    ...
    Dieses Symbol ist in der Hauptressourcendatei "Camera_capture.rc" 
    enthalten.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "Camera_capture.pch und eine 
