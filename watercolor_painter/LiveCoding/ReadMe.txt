Please note:
Several textures, DLLs, headers and so on are missing. Those can
be copied from LiveCodingHRMK.

========================================================================
    WIN32-ANWENDUNG: LiveCoding-Projektübersicht
========================================================================

Diese LiveCoding-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre LiveCoding-Anwendung besteht.
...
LiveCoding.ico
    ...
    Dieses Symbol ist in der Hauptressourcendatei "LiveCoding.rc" 
    enthalten.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "LiveCoding.pch und eine 
