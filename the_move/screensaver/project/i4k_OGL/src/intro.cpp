...
void ball8Preview(float ftime)
{
	...
	if (ftime > 7.7f)
	{
		parameterMatrix[1] = sqrtf(ftime - 7.7f) * 1.25f;
		if (parameterMatrix[1] > 1.5f) parameterMatrix[1] = 1.5f; 
	}
	if (ftime < 8.0f)
	{
...
void ball8Scene(float ftime)
{
	...
	if (ftime < dTime)
	{
		parameterMatrix[8] = params.getParam(8, 0.36f);
		parameterMatrix[9] = params.getParam(9, 0.47f);
		parameterMatrix[10] = params.getParam(12, 0.43f);
		parameterMatrix[11] = params.getParam(13, 0.01f);
		parameterMatrix[2] = 4.0f * params.getParam(2, 0.46f); // y position of the ball
		parameterMatrix[5] = params.getParam(3, 0.32f); // z position
		parameterMatrix[14] = 6.24f * params.getParam(4, 0.51f); // rotation around z
		//parameterMatrix[14] = -2.7f; // Roation around z
		parameterMatrix[15] = ftime * 0.2f + 6.24f * params.getParam(5, 0.0f); // Rotation around y
	}
	else if (ftime < 2.0f * dTime)
	{
		parameterMatrix[8] = params.getParam(8, 0.19f);
		parameterMatrix[9] = params.getParam(9, 0.55f);
		parameterMatrix[10] = params.getParam(12, 0.41f);
		parameterMatrix[11] = params.getParam(13, 0.76f);
		parameterMatrix[2] = 4.0f * params.getParam(2, 0.34f); // y position of the ball
		parameterMatrix[5] = params.getParam(3, 0.0f); // z position
		parameterMatrix[14] = 6.24f * params.getParam(4, 0.50f); // rotation around z
		parameterMatrix[15] = ftime * 0.2f + 6.24f * params.getParam(5, 0.42f); // Rotation around y
	...
	{
		parameterMatrix[8] = params.getParam(8, 0.11f);
		parameterMatrix[9] = params.getParam(9, 0.18f);
		parameterMatrix[10] = params.getParam(12, 0.20f);
		parameterMatrix[11] = params.getParam(13, 0.39f);
		parameterMatrix[5] = params.getParam(3, 0.0f); // z position
		parameterMatrix[14] = 6.24f * params.getParam(4, 0.57f); // rotation around z
		parameterMatrix[15] = ftime * 0.2f + 6.24f * params.getParam(5, 0.45f); // Rotation around y
	...
	{//8:0.59(75) 9:0.25(32) 12:0.23(29) 13:0.39
		//8:0.78(99) 9:0.56(71) 12:0.80(102) 13:0.69(88) 
		parameterMatrix[8] = params.getParam(8, 0.78f);
		parameterMatrix[9] = params.getParam(9, 0.56f);
		parameterMatrix[10] = params.getParam(12, 0.80f);
		parameterMatrix[11] = params.getParam(13, 0.69f);
		...
		parameterMatrix[1] = 0.5f + (ftime - 3.0f*dTime) * 0.2f; // amount of lightstream
	}
	else if (ftime < 5.0f * dTime)
	{
		parameterMatrix[8] = params.getParam(8, 0.0f);
		parameterMatrix[9] = params.getParam(9, 0.0f);
		parameterMatrix[10] = params.getParam(12, 0.00f);
		parameterMatrix[11] = params.getParam(13, 0.0f);
	...
	{
		parameterMatrix[8] = params.getParam(8, 0.09f);
		parameterMatrix[9] = params.getParam(9, 0.0f);
		parameterMatrix[10] = params.getParam(12, 0.34f);
		parameterMatrix[11] = params.getParam(13, 0.0f) + (ftime-6*dTime)*0.075f;
	...
	else if (ftime < 7.0f * dTime)
	{
		parameterMatrix[8] = params.getParam(8, 0.0f);
		parameterMatrix[9] = params.getParam(9, 0.0f);
		parameterMatrix[10] = params.getParam(12, 0.0f);
		parameterMatrix[11] = params.getParam(13, 0.0f);
		...
		parameterMatrix[1] = 1.22f; // amount of lightstream
	}
	...
	{
		parameterMatrix[8] = params.getParam(8, 0.17f);
		parameterMatrix[9] = params.getParam(9, 0.61f);
		parameterMatrix[10] = params.getParam(12, 0.63f);
		parameterMatrix[11] = params.getParam(13, 0.02f);


		parameterMatrix[2] = 2.0f; // y position of the ball	
		parameterMatrix[14] = 6.24f * params.getParam(4, 0.485f); // Roation around z
		parameterMatrix[15] = (ftime-8*dTime) * 0.2f; // Rotation around y
	}
	else if (ftime < 10*dTime)
	{
		parameterMatrix[8] = params.getParam(8, 0.55f);
		parameterMatrix[9] = params.getParam(9, 0.44f);
		parameterMatrix[10] = params.getParam(12, 0.28f);
		parameterMatrix[11] = params.getParam(13, 0.0f);
	...
	else
	{
		...
		parameterMatrix[15] = params.getParam(5, 0.0f) * 6.14f;
	}
	glLoadMatrixf(parameterMatrix);
