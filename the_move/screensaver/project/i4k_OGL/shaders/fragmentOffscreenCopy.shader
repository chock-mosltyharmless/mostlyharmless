...
{  
   ...
   gl_FragColor = 0.125 * texture2D(Texture0, gl_TexCoord[0].xy + 0.001*noiseVal.xy);
   ...
   gl_FragColor += 0.125 * texture2D(Texture0, gl_TexCoord[0].xy + 0.001*noiseVal.xy) + noiseVal.x*0.01 - 0.015;
