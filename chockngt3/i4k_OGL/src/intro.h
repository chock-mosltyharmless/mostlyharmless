...
#define glBindAttribLocation ((PFNGLBINDATTRIBLOCATIONPROC)glFP[18])
#ifdef SHADER_DEBUG
#define glGetShaderiv ((PFNGLGETSHADERIVPROC)glFP[19])
#define glGetShaderInfoLog ((PFNGLGETSHADERINFOLOGPROC)glFP[20])
#define glGetProgramiv ((PFNGLGETPROGRAMIVPROC)glFP[21])
#endif
