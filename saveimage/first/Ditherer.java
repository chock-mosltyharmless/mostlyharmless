...
//                                    0.30 * dArray[2];
    ...
    public void doColorDither()
    {
        ...
        if (pixel2x1)
        {
            errorDiff[0][4] += errorDiff[0][3] / 2;
            errorDiff[1][2] += errorDiff[0][3] / 2;
            errorDiff[1][4] += errorDiff[1][3] / 2;
            errorDiff[2][2] += errorDiff[1][3] / 2;
            errorDiff[1][3] = 0.0;
            errorDiff[0][3] = 0.0;
        }

        for (int iteration = 0; iteration < 2 && (iteration == 0 || color4); iteration++)
        {
