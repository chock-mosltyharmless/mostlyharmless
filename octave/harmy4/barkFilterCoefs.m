function R = barkFilterCoefs(FFTLength, barkBorders)
% R = barkFilterCoefs
%
...
% SampleRate must be 44100
  ...
  for k = 1:numBands
    ...
    R(barkBorders(k)+1:barkBorders(k+1)-1, k) = 1;
    R(barkBorders(k)+1, k) = 0.5;    
    R(barkBorders(k+1)-1, k) = 0.5;
  end
