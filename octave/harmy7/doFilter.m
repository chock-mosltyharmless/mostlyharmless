%filename = 'voice/man1.wav'
%filename = 'drums/drum24.wav'
%filename = 'voice/woman4.wav'
%filename = 'voice/atomicPlayboy2.wav'
%filename = 'voice/HUMAN_VOICE_SING_FIESTA_01.wav'
