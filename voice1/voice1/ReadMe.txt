========================================================================
    WIN32-ANWENDUNG: voice1-Projektübersicht
========================================================================

Diese voice1-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre voice1-Anwendung besteht.
...
voice1.ico
    ...
    Dieses Symbol ist in der Hauptressourcendatei "voice1.rc" 
    enthalten.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "voice1.pch und eine 
