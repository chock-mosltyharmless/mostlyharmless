...
public: // functions
    ...
    // Does not work if getVideoID was called before
    int GetVideoFrameID(const char *name, GLuint *id, char *errorString, int frame_index);
...
private: // data
    ...
    int video_frame_index_[TM_MAX_NUM_VIDEOS];
};
