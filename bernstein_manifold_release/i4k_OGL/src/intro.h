...
#ifdef SHADER_DEBUG
#define glGetShaderiv ((PFNGLGETSHADERIVPROC)glFP[18])
#define glGetShaderInfoLog ((PFNGLGETSHADERINFOLOGPROC)glFP[19])
#define glGetProgramiv ((PFNGLGETPROGRAMIVPROC)glFP[20])
#endif
